...
This Cookie Policy explains how **Sleeptrackly** ("**Company**," "**we**," "**us**," and "**our**") uses cookies and similar technologies to recognize you when you visit our website at [https://www.sleeptrackly.com](https://www.sleeptrackly.com) ("**Website**"). It explains what these technologies are and why we use them, as well as your rights to control our use of them.
...
Cookies set by the website owner (in this case, **Sleeptrackly**) are called "first-party cookies." Cookies set by parties other than the website owner are called "third-party cookies." Third-party cookies enable third-party features or functionality to be provided on or through the website (e.g., advertising, interactive content, and analytics). The parties that set these third-party cookies can recognize your computer both when it visits the website in question and also when it visits certain other websites.
...
| :------------- | :---------------------------------------------------------- |
| **Name**       | `session`                                                   |
| **Purpose**    | Used to maintain an active user session and authentication. |
| **Provider**   | Sleeptrackly                                                |
...
| Attribute      | Details 1                                            | Details 2                                                           |
| :------------- | :--------------------------------------------------- | :------------------------------------------------------------------ |
| **Name**       | `_ga`                                                | `_ga_<container-id>`                                                |
| **Purpose**    | Used to distinguish users and understand site usage. | Used to persist session state and track user behavior across pages. |
| **Provider**   | Google LLC                                           | Google LLC                                                          |
| **Service**    | Google Analytics                                     | Google Analytics                                                    |
| **Type**       | html_cookie                                          | html_cookie                                                         |
| **Expires in** | 2 years (730 days)                                   | 2 years (730 days)                                                  |
...
If you have any questions about our use of cookies or other technologies, please email us at [support@sleeptrackly.com](mailto:support@sleeptrackly.com) or by post to:
