...
| Attribute      | session                                                     | previousPage                                                                  |
| :------------- | :---------------------------------------------------------- | :---------------------------------------------------------------------------- |
| **Name**       | `session`                                                   | `previousPage`                                                                |
| **Purpose**    | Used to maintain an active user session and authentication. | Used to remember the previous page for redirecting after login or navigation. |
| **Provider**   | Sleeptrackly                                                | Sleeptrackly                                                                  |
| **Service**    | Authentication                                              | Sleeptrackly                                                                  |
| **Type**       | server_cookie                                               | server_cookie                                                                 |
| **Expires in** | 30 days                                                     | 15 mins                                                                       |
