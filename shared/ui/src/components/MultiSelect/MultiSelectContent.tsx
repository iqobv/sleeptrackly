...
interface MultiSelectContentProps extends Popover.PopoverContentProps {
...
export const MultiSelectContent = ({
	...
	const { isOpen, triggerRef } = useMultiSelectContext();
			...
			{isOpen && (
				<Popover.Portal forceMount>
					<Popover.Content
						...
						style={{ minWidth: 'var(--radix-popover-trigger-width)', ...style }}
